...
properties:
  ...
  20 FLOAT fWhatever = 1.0f, 
	21 BOOL  m_bEnemyRight = FALSE,
 ...
 ************************************************************/
  Fire(EVoid) : CEnemyBase::Fire {
    ...
    m_bEnemyRight = fLookRight % (m_penEnemy->GetPlacement().pl_PositionVector - GetPlacement().pl_PositionVector);

    if (m_bEnemyRight>=0) {  // enemy is to the right of guffy
    ...
    autowait(GetModelObject()->GetAnimLength(GUFFY_ANIM_FIRE));
 ...
 ************************************************************/
  Main(EVoid) {
    ...
    m_fSize = 1.5f*fWhatever;
    GetModelObject()->StretchModel(FLOAT3D(m_fSize, m_fSize*1.25f, m_fSize));
    ModelChangeNotify();

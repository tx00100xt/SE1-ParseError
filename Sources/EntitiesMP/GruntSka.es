...
#define SOLIDER_SMC_MODEL "ModelsSKA\\Enemies\\Grunt\\Soldier.smc"
...
*/
  ...
  void StandingAnim(void) {
    GetModelInstance()->AddAnimation(idGrunt_IdlePatrol,AN_LOOPING|AN_NORESTART|AN_CLEAR,1,0);
  };
 ...
 ************************************************************/
  ...
  SoldierAttack(EVoid) {
    ...
    GetModelInstance()->AddAnimation(idGrunt_Fire,AN_LOOPING|AN_NORESTART|AN_CLEAR,1,0);
    ShootProjectile(PRT_GRUNT_PROJECTILE_SOL, FIREPOS_SOLDIER, ANGLE3D(0, 0, 0));

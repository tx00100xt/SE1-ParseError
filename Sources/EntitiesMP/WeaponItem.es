...
#include "Models/Weapons/Bomb/BombItem.h"
...
#include "Models/QuestionMark/QuestionMark.h"
...
enum WeaponItemType {
  ...
  3 WIT_DOUBLESHOTGUN     "Teleporter Gun",
...
properties:
  ...
  10 BOOL m_bCreateTouchBox = TRUE,
	11 BOOL m_bReplaced = FALSE,
...
// ************** DOUBLE SHOTGUN **************
 50 model   MODEL_QUESTION_MARK         "Models\\QuestionMark\\QuestionMark.mdl",
 51 texture TEXTURE_QUESTION_MARK       "Models\\QuestionMark\\QuestionMark.tex",
/*
...
*/
// ************** TOMMYGUN *************
 70 model   MODEL_BOMB                  "Models\\Weapons\\Bomb\\BombItem.mdl",
 72 model   MODEL_BOMB_BIG              "Models\\Weapons\\Bomb\\BombBig.mdl",
 75 texture TEXTURE_BOMB                "Models\\Weapons\\Bomb\\Bomb.tex",
/*
...
// ************** MINIGUN **************
 ...
 99 texture TEXTURE_MG_BARRELS           "Models\\Weapons\\Mini2\\Barrels.tex",
 85 model   MODEL_MG_ENGINE              "Models\\Weapons\\Mini2\\Engine.mdl",
/*
...
functions:
  ...
  void Precache(void) {
    ...
    switch (m_EwitType) {
      ...
      case WIT_SINGLESHOTGUN:   CPlayerWeapons_Precache(1<<(INDEX(WEAPON_SINGLESHOTGUN  )-1)); break;
      case WIT_DOUBLESHOTGUN://   CPlayerWeapons_Precache(1<<(INDEX(WEAPON_DOUBLESHOTGUN  )-1)); break;
				AddItem(MODEL_QUESTION_MARK, TEXTURE_QUESTION_MARK, TEX_REFL_LIGHTMETAL01, TEX_SPEC_MEDIUM, 0);	
        StretchItem( FLOAT3D(1.0f, 1.0f, 1.0f));				
			break;
      case WIT_TOMMYGUN: //       CPlayerWeapons_Precache(1<<(INDEX(WEAPON_TOMMYGUN       )-1));
				AddItem(MODEL_BOMB, TEXTURE_BOMB, TEX_REFL_DARKMETAL, TEX_SPEC_MEDIUM, 0);
        StretchItem( FLOAT3D(1.75f, 1.75f, 1.75f));
		  break;
      case WIT_MINIGUN://         CPlayerWeapons_Precache(1<<(INDEX(WEAPON_MINIGUN        )-1)); 
				AddItem(MODEL_MINIGUN, TEXTURE_MG_BODY, 0, 0, 0);
        AddItemAttachment(MINI2GUNITEM_ATTACHMENT_BODY, MODEL_MG_BODY, TEXTURE_MG_BODY, TEX_REFL_LIGHTMETAL01, TEX_SPEC_MEDIUM, 0);
        AddItemAttachment(MINI2GUNITEM_ATTACHMENT_BARRELS01, MODEL_MG_BARRELS01, TEXTURE_MG_BARRELS, TEX_REFL_LIGHTMETAL01, TEX_SPEC_MEDIUM, 0);
        AddItemAttachment(MINI2GUNITEM_ATTACHMENT_BARRELS02, MODEL_MG_BARRELS02, TEXTURE_MG_BARRELS, TEX_REFL_LIGHTMETAL01, TEX_SPEC_MEDIUM, 0);
				AddItemAttachment(MINI2GUNITEM_ATTACHMENT_ENGINE, MODEL_MG_ENGINE, TEXTURE_MG_BARRELS, TEX_REFL_LIGHTMETAL01, TEX_SPEC_MEDIUM, 0);
        StretchItem( FLOAT3D(1.75f, 1.75f, 1.75f));
		  break;
      case WIT_ROCKETLAUNCHER:  CPlayerWeapons_Precache(1<<(INDEX(WEAPON_ROCKETLAUNCHER )-1)); break;
      case WIT_GRENADELAUNCHER: CPlayerWeapons_Precache(1<<(INDEX(WEAPON_GRENADELAUNCHER)-1)); break;
  ...
  void RenderParticles(void) {
    ...
    if (GetRenderType()!=CEntity::RT_MODEL || GetSP()->sp_gmGameMode>CSessionProperties::GM_COOPERATIVE
      || !ShowItemParticles() || GetSP()->sp_bCooperative ) {
			return;
		}
		switch (m_EwitType) {
    ...
    // *********** DOUBLE SHOTGUN ***********
      case WIT_DOUBLESHOTGUN:
        ...
        m_strDescription.PrintF("Double Shotgun");
				AddItem(MODEL_QUESTION_MARK, TEXTURE_QUESTION_MARK, TEX_REFL_LIGHTMETAL01, TEX_SPEC_MEDIUM, 0);
        StretchItem( bDM ? vDMStretch : (FLOAT3D(1.7f, 1.7f, 1.7f)));
        break;
    ...
    // *********** TOMMYGUN ***********
      case WIT_TOMMYGUN:
        ...
        AddItem(MODEL_BOMB, TEXTURE_BOMB, 0, 0, 0);
				AddItemAttachment(BOMBITEM_ATTACHMENT_BOMB, MODEL_BOMB_BIG, TEXTURE_BOMB, TEX_REFL_DARKMETAL, TEX_SPEC_MEDIUM, 0);
        StretchItem( bDM ? vDMStretch : (FLOAT3D(0.8f, 0.8f, 0.8f)));
        break;
...
procedures:
  ItemCollected(EPass epass) : CItem::ItemCollected {
    ...
    if (IsOfClass(epass.penOther, "PlayerBot") && m_penTarget==NULL) {
      return;
    }

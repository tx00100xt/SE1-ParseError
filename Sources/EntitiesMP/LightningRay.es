...
#define HIT_DAMAGE 30.0f         // hit damage for every lerping bullet

void CLightningRay_OnPrecache(CDLLEntityClass *pdec, INDEX iUser) 
{
...
class CLightningRay : CMovableModelEntity {
name      "LightningRay";
thumbnail "";
...
functions:
  ...
  void RenderParticles(void)
  {
    ...
    Particles_Ghostbuster(vLerpedSrc, vLerpedDst, 8, 1.0f);
  };
 ...
 ************************************************************/
  ...
  void PostMoving(void) {
    ...
    ((CPlayerWeapons&)*m_penOwner).GetLightningRaySourcePlacement(plSource);
...
procedures:
  // --->>> MAIN
  Main(ELightningRay elr) {
    // store owner
    ASSERT(elr.penOwner!=NULL);
    m_penOwner = elr.penOwner;

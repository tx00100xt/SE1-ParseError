...
#include "Models/Weapons/Knife/Projectile/KnifeProjectile.h"
//#include "Models/Weapons/Laser/Projectile/Plasma.h"
#include "Models/Weapons/Laser/Projectile/Ball.h"
#include "ModelsMP/Weapons/Flamer/Projectile/FlamerProjectile.h"
#include "Models/Weapons/Bomb/Projectile/BombProjectile.h"
...
enum ProjectileType {
 ...
 78 PRT_KNIFE_PROJECTILE      "Knife Projectile", // knife projectile
 79 PRT_ROCKET_HOMING         "Homing Rocket",  // homing rocket
 80 PRT_LASER_BOMB            "Laser Bomb",  // laser bomb
 81 PRT_FLAMER_PROJECTILE     "Flamer Projectile", // flamer projectile
 82 PRT_BOMB                  "Bomb",
 83 PRT_GRENADE_BOMB          "Grenade Bomb",
 84 PRT_BOT_BOMB              "Player Bot Bomb",
 85 PRT_BOT_ROCKET            "Player Bot Rocket",
 86 PRT_BOT_HOMING_ROCKET     "Player Bot Homing Rocket"
};
...
void CProjectile_OnPrecache(CDLLEntityClass *pdec, INDEX iUser) 
{
  ...
  case PRT_LASER_RAY:
    ...
    pdec->PrecacheTexture(TEXTURE_BALL                   );
  ...
  case PRT_LASER_BOMB:
    pdec->PrecacheModel(MODEL_BALL                       );
    pdec->PrecacheTexture(TEXTURE_BALL                   );
    pdec->PrecacheClass(CLASS_BASIC_EFFECT, BET_EXPLOSION02  );
	  pdec->PrecacheClass(CLASS_BASIC_EFFECT, BET_PLANE_EXPLOSION02 );
    break;

  case PRT_KNIFE_PROJECTILE:
    pdec->PrecacheModel(MODEL_KNIFE_PROJECTILE);
	  pdec->PrecacheTexture(TEXTURE_KNIFE_PROJECTILE);
    pdec->PrecacheClass(CLASS_BASIC_EFFECT, BET_KNIFE_IMPACT);
	break;
  ...
  case PRT_AFTERBURNER_DEBRIS:
    ...
    break;
	case PRT_FLAMER_PROJECTILE:
    pdec->PrecacheModel(MODEL_FLAMER_PROJECTILE);
    pdec->PrecacheTexture(TEXTURE_FLAMER_PROJECTILE);    
    break;
  case PRT_BOMB:
    pdec->PrecacheModel(MODEL_BOMB);
    pdec->PrecacheTexture(TEXTURE_BALL);
    pdec->PrecacheSound(SOUND_GRENADE_BOUNCE);
    pdec->PrecacheClass(CLASS_BASIC_EFFECT, BET_DB_EXPLOSION);
...
properties:
 ...
 60 FLOAT m_fProjectileSpeed = 0.0f,
 61 BOOL  m_bRenderParticles = TRUE,
 62 BOOL  m_bRenderMentalParticles = FALSE,
 63 COLOR m_colStar = C_WHITE,
...
// ********* WALKER LASER *********
 ...
 51 texture TEXTURE_BLUE_LASER    "Models\\Weapons\\Laser\\Projectile\\LaserProjectileBlue.tex",

// ********* PLAYER LASER RAY, BOMB *********
 //52 model   MODEL_BALL            "Models\\Weapons\\Laser\\Projectile\\Ball.mdl",
 //53 texture TEXTURE_BALL          "Models\\Weapons\\Laser\\Projectile\\Ball.tex",
 52 model   MODEL_BALL            "Models\\Weapons\\Laser\\Projectile\\LaserProjectile.mdl",
 53 texture TEXTURE_BALL          "Models\\Weapons\\Laser\\Projectile\\LaserProjectile.tex",

// ************ PLAYER BOMB ***********
 54 model   MODEL_BOMB             "Models\\Weapons\\Bomb\\Projectile\\BombProjectile.mdl",
 55 texture TEXTURE_BOMB           "Models\\Weapons\\Bomb\\Projectile\\BombProjectile.tex",

// ************* KNIFE PROJECTILE ************
 56 model   MODEL_KNIFE_PROJECTILE    "Models\\Weapons\\Knife\\Projectile\\KnifeProjectile.mdl",
 57 texture TEXTURE_KNIFE_PROJECTILE  "Models\\Weapons\\Knife\\Projectile\\KnifeProjectile.tex",

// ********** FLAMER PROJECTILE *********
 58 model   MODEL_FLAMER_PROJECTILE    "ModelsMP\\Weapons\\Flamer\\Projectile\\FlamerProjectile.mdl",
 59 texture TEXTURE_FLAMER_PROJECTILE  "ModelsMP\\Weapons\\Flamer\\Projectile\\FlamerProjectile.tex",
  ...
  BOOL AdjustShadingParameters(FLOAT3D &vLightDirection, COLOR &colLight, COLOR &colAmbient)
  {
    ...
    if ( (pmo != NULL) && (_pTimer->GetLerpedCurrentTick() < (m_fStartTime+m_tmInvisibility) ) ) {
      ...
      pmo->mo_colBlendColor = 0;
			...
			/*if (GetSP()->sp_bMental && IsDerivedFromClass(m_penLauncher, "Enemy Base")) {
				GetModelObject()->mo_colBlendColor = C_WHITE|130;
			} else {*/
				// make it visible
  ...
  void RenderParticles(void) {
    if (m_bRenderParticles) {
      switch (m_prtType) {
        ...
        case PRT_BOT_ROCKET:
        case PRT_BOT_HOMING_ROCKET:
          Particles_RocketTrail(this, 0.5f); 
          break; 
        ...
        case PRT_BEAST_PROJECTILE: Particles_BeastProjectileTrail( this, 2.0f, 0.25f, 16); break;
        case PRT_BEAST_BIG_PROJECTILE:
        case PRT_DEMON_FIREBALL:
          Particles_BeastBigProjectileTrail( this, 4.0f, 0.25f, 0.0f, 32);
  //        Particles_AfterBurner( this, m_fStartTime, 1.0f);
          break;
        case PRT_DEVIL_GUIDED_PROJECTILE:
          Particles_BeastBigProjectileTrail( this, 6.0f, 0.375f, 0.0f, 32);
          break;
        ...
        case PRT_AIRELEMENTAL_WIND:
          ...
          break;
        case PRT_KNIFE_PROJECTILE: Particles_KnifeTrail01(this); break;
        case PRT_ROCKET_HOMING: Particles_RocketTrail(this, 2.0f); break;
			  case PRT_FLAMER_PROJECTILE: //Particles_BeastBigProjectileTrail( this, 4.0f, 0.25f, 0.0f, 32); break;
				  {
				  FLOAT fRender = m_fStartTime + 0.25f;
				  if (_pTimer->CurrentTick() > fRender) {
					  Particles_BeastBigProjectileTrail( this, 3.0f, 0.25f, 0.0f, 32); 
				  }
				  break;
			  }
      }
		...
		if (m_bRenderMentalParticles) {
			Particles_ModelGlow3(this, PT_STAR07, 0.25f, 2, m_colStar);
		}
  }
...
void PlayerRocket(void) {
  ...
  // start moving
  LaunchAsPropelledProjectile(FLOAT3D(0.0f, 0.0f, -(75.0f)*m_fProjectileSpeed), (CMovableEntity*)(CEntity*)m_penLauncher);
  SetDesiredRotation(ANGLE3D(0, 0, 0));
  // play the flying sound
  m_soEffect.Set3DParameters(1.0f, 0.1f, 0.1f, 0.5f);
...
void PlayerHomingRocket(void) {
  ...
  /*FLOAT fSpeedAdj = m_fProjectileSpeed;
  fSpeedAdj /= 2;
  if (fSpeedAdj<1) {
    fSpeedAdj = 1.0f;
  }

  m_fGuidedMaxSpeedFactor = 35.0f*fSpeedAdj;

  // start moving
  LaunchAsPropelledProjectile(FLOAT3D(0.0f, 0.0f, -m_fGuidedMaxSpeedFactor), (CMovableEntity*)(CEntity*)m_penLauncher);*/
  ...
  SetHealth(5.0f);
  CEntityPointer pw;
  pw = ((CPlayer*) m_penLauncher.ep_pen)->GetPlayerWeapons();
  m_penTarget = ((CPlayerWeapons*) &*pw)->m_penRocketLauncherHoming;
  m_pmtMove = PMT_GUIDED_PE;
	//m_pmtMove = PMT_GUIDED;
  m_aRotateSpeed = 300.0f;
};

void PlayerFlamerProjectile(void) {
  // set appearance
  InitAsModel();
  SetPhysicsFlags(EPF_MODEL_FREE_FLYING);
  SetCollisionFlags(ECF_PROJECTILE_SOLID);

  SetModel(MODEL_FLAMER_PROJECTILE);
  SetModelMainTexture(TEXTURE_FLAMER_PROJECTILE);
  ...
  // start moving
  LaunchAsPropelledProjectile(FLOAT3D(0.0f, 0.0f, -((50.0f*fSpeedAdj)+fSpeedFwd)), (CMovableEntity*)(CEntity*)m_penLauncher);
  SetDesiredRotation(ANGLE3D(0, 0, 0));
  m_fFlyTime = 10.0f;
  m_fDamageAmount = 300.0f;
  m_fRangeDamageAmount = 200.0f;
  ...
  m_tmExpandBox = 0.1f;
  m_tmInvisibility = 0.1f;
  CEntityPointer pw;
  pw = ((CPlayer*) m_penLauncher.ep_pen)->GetPlayerWeapons();
  m_penTarget = ((CPlayerWeapons*) &*pw)->m_penFlamerProjectile;
  m_pmtMove = PMT_GUIDED;
  SetHealth(11.0f);
  m_aRotateSpeed = 150.0f;
};

void PlayerFlamerProjectileExplosion(void)
{
  // explosion
  ESpawnEffect ese;
  ...
  eSpawnSpray.fDamagePower = 20.0f;
...
void PlayerGrenade(void) {
  ...
  // start moving
  LaunchAsFreeProjectile(FLOAT3D(0.0f, 0.0f, -(m_fSpeed)*m_fProjectileSpeed), (CMovableEntity*) m_penLauncher.ep_pen);
  ...
  m_fFlyTime = 3.0f;
  m_fDamageAmount = 80.0f;
  m_fRangeDamageAmount = 80.0f;
  m_fDamageHotSpotRange = 6.0f;
  m_fDamageFallOffRange = 8.0f;
  m_fSoundRange = 15.0f;
  m_bExplode = TRUE;
...
void PlayerHomingRocketExplosion(void) {
...
void PlayerGrenadeBomb(void) {
  ...
  SetModel(MODEL_GRENADE);
  SetModelMainTexture(TEXTURE_GRENADE);
	GetModelObject()->StretchModel(FLOAT3D(2.3f, 2.3f, 2.3f));
...
void PlayerGrenadeBombExplosion(void) {
...
void PlayerBomb(void) {
  ...
  // add player's forward velocity
  /*MovableEntity *penPlayer = (CMovableEntity*)(CEntity*)m_penLauncher;
  FLOAT3D vDirection = penPlayer->en_vCurrentTranslationAbsolute;
  FLOAT3D vFront = -GetRotationMatrix().GetColumn(3);
  FLOAT fSpeedFwd = ClampDn( vDirection%vFront, 0.0f);*/

	FLOAT fSpeed = ClampDn(-100.0f*m_fProjectileSpeed, -300.0f);

  // start moving
  LaunchAsFreeProjectile(FLOAT3D(0.0f, 0.0f, fSpeed), (CMovableEntity*) m_penLauncher.ep_pen);
  SetDesiredRotation(ANGLE3D(0, FRnd()*120.0f+120.0f, FRnd()*250.0f-125.0f));
  en_fBounceDampNormal   = 0.75f;
  en_fBounceDampParallel = 0.6f;
  en_fJumpControlMultiplier = 0.0f;
...
void PlayerBombExplosion(void)
{
  ...
  //FLOAT fDistanceToEdge;
	CPlacement3D plExplosionOffset = GetPlacement();
	plExplosionOffset.pl_PositionVector(2) +=	1.5f; 

  // explosion
  ese.colMuliplier = C_WHITE|CT_OPAQUE;
  ese.betType = BET_DB_EXPLOSION;
  ese.vStretch = FLOAT3D(0.9f,0.9f,0.9f);
  SpawnEffect(plExplosionOffset, ese);
  ...
  SpawnEffect(plExplosionOffset, ese);
	...
	// shock wave vertical 1
	/*ese.colMuliplier = C_WHITE|CT_OPAQUE;
	ese.betType = BET_CANNONSHOCKWAVE_VERT;
	ese.vStretch = FLOAT3D(1.5f,1.5f,1.5f);
	SpawnEffect(plExplosionOffset, ese);

	// shock wave vertical 2
	plExplosionOffset.pl_OrientationAngle(1) +=	90.0f;
	ese.colMuliplier = C_WHITE|CT_OPAQUE;
	ese.betType = BET_CANNONSHOCKWAVE_VERT;
	ese.vStretch = FLOAT3D(1.5f,1.5f,1.5f);
	SpawnEffect(plExplosionOffset, ese);*/
...
void PlayerKnifeProjectile(void) {
  // set appearance
  InitAsModel();
  SetPhysicsFlags(EPF_PROJECTILE_FLYING);
  SetCollisionFlags(ECF_PROJECTILE_SOLID);
  SetModel(MODEL_KNIFE_PROJECTILE);
  CModelObject *pmo = GetModelObject();
  SetModelMainTexture(TEXTURE_KNIFE_PROJECTILE);
  GetModelObject()->StretchModel(FLOAT3D(2.0f, 2.0f, 2.0f));
  ...
  // start moving
  LaunchAsPropelledProjectile(FLOAT3D(0.0f, 0.0f, -(70.0f+fSpeedFwd)), (CMovableEntity*)(CEntity*)m_penLauncher);
  SetDesiredRotation(ANGLE3D(0, 0, 0));
  m_fFlyTime = 6.0f;
  m_fDamageAmount = 150.0f;
  m_fSoundRange = 0.0f;
  ...
  m_fWaitAfterDeath = 0.0f;
  m_tmExpandBox = 0.1f;
  // time when knife becomes visible
  m_tmInvisibility = 0.025f;
  m_pmtMove = PMT_FLYING;
};
//*/

// NEW CODE KNIFE PROJECTILE HIT
void PlayerKnifeProjectileImpact(void) {
  ESpawnEffect ese;
  FLOAT3D vPoint;
  FLOATplane3D vPlaneNormal;
  FLOAT fDistanceToEdge;
...
void PlayerLaserRay(void) {
  ...
  SetModel(MODEL_BALL);
  SetModelMainTexture(TEXTURE_BALL);
  GetModelObject()->StretchModel(FLOAT3D(0.5f, 0.5f, 1.0f));
  ModelChangeNotify();
  ...
  // start moving
  LaunchAsPropelledProjectile(FLOAT3D(0.0f, 0.0f, -(150.0f)*fSpeedAdj), (CMovableEntity*)(CEntity*)m_penLauncher);
  SetDesiredRotation(ANGLE3D(0, 0, 0));
  m_fFlyTime = 4.0f/fSpeedAdj;
  m_fDamageAmount = 70.0f;
...
void PlayerLaserWave(void) {
	...
	// explosion debris
	ESpawnEffect ese;
	ese.colMuliplier = C_lGREEN|CT_OPAQUE;
  ...
  if (GetNearestPolygon(vPoint, vPlaneNormal, fDistanceToEdge)) {
    if ((vPoint-GetPlacement().pl_PositionVector).Length() < 3.5f) {
      ...
      ese.vNormal = FLOAT3D(vPlaneNormal);
      ese.vStretch = FLOAT3D(0.25f,0.25f,0.25f);
      SpawnEffect(CPlacement3D(vPoint, ANGLE3D(0, 0, 0)), ese);
    }
  }*/
};
...
void PlayerLaserBomb(void) {
  ...
  // start moving
  LaunchAsPropelledProjectile(FLOAT3D(0.0f, 0.0f, -(60.0f)*fSpeedAdj), (CMovableEntity*)(CEntity*)m_penLauncher);
  SetDesiredRotation(ANGLE3D(0, 0, 0));
  // play the flying sound
  m_soEffect.Set3DParameters(20.0f, 2.0f, 1.0f, 1.0f);
  PlaySound(m_soEffect, SOUND_FLYING, SOF_3D|SOF_LOOP);
...
void PlayerLaserBombExplosion(void) {

  ESpawnEffect ese;

  // explosion
  ese.colMuliplier = C_lBLUE|CT_OPAQUE;
  ese.betType = BET_EXPLOSION02;
  ese.vStretch = FLOAT3D(1,1,1);
  SpawnEffect(GetPlacement(), ese);
...
void BotHomingRocket(void) {
  ...
  SetDesiredRotation(ANGLE3D(0, 0, 0));
  // play the flying sound
  m_soEffect.Set3DParameters(30.0f, 2.0f, 1.0f, 1.0f);
  PlaySound(m_soEffect, SOUND_FLYING, SOF_3D|SOF_LOOP);
  m_fFlyTime = 10.0f;
  m_fDamageAmount = 300.0f;
  m_fRangeDamageAmount = 300.0f;
  m_fDamageHotSpotRange = 12.0f;
  ...
  m_tmInvisibility = 0.05f;
  SetHealth(5.0f);
  m_penTarget = ((CPlayerBot*)&*m_penLauncher)->m_penHoming;
  m_pmtMove = PMT_GUIDED;
...
void BotBomb(void) {
  ...
  // start moving
  //LaunchAsFreeProjectile(FLOAT3D(0.0f, 0.0f, -200.0f), (CMovableEntity*) m_penLaunche.ep_penr);
  LaunchAsPropelledProjectile(FLOAT3D(0.0f, 0.0f, -200.0f), (CMovableEntity*) m_penLauncher.ep_pen);
  //SetDesiredRotation(ANGLE3D(0, FRnd()*120.0f+120.0f, FRnd()*250.0f-125.0f));
  SetDesiredRotation(ANGLE3D(0, 0, 0));
  //en_fBounceDampNormal   = 0.75f;
  //en_fBounceDampParallel = 0.6f;
...
void HeadmanBomberman(void) {
  ...
  // start moving
  LaunchAsFreeProjectile(FLOAT3D(0.0f, 0.0f, -m_fSpeed*1.5f), (CMovableEntity*) m_penLauncher.ep_pen);
...
void WomanProjectile(void) {
  // we need a target for the guided missile, YOU!
...
void BeastProjectile(void) {
  ...
  if (GetSP()->sp_bMental) {
		...
		GetModelObject()->StretchModel(FLOAT3D(4.5f, 4.5f, 4.5f));
...
void BeastBigProjectile(void) {
  ...
  if (GetSP()->sp_bMental) {
		SetModel(MODEL_HEADMAN_BOMB);
		SetModelMainTexture(TEXTURE_BEAST_BIG_FIRE);
		GetModelObject()->StretchModel(FLOAT3D(5.5f, 5.5f, 5.5f));
...
void GruntSoldierLaser(void) {
  ...
  // start moving
  LaunchAsPropelledProjectile(FLOAT3D(0.0f, 0.0f, -95.0f), (CMovableEntity*)(CEntity*)m_penLauncher);
  SetDesiredRotation(ANGLE3D(0, 0, 0));
  m_fFlyTime = 3.0f;
  m_fDamageAmount = 10.0f;
  m_fSoundRange = 0.0f;
...
void GruntCommanderLaser(void) {
  ...
  // start moving
  LaunchAsPropelledProjectile(FLOAT3D(0.0f, 0.0f, -105.0f), (CMovableEntity*)(CEntity*)m_penLauncher);
  SetDesiredRotation(ANGLE3D(0, 0, 0));
  m_fFlyTime = 3.0f;
  m_fDamageAmount = 10.0f;
  m_fSoundRange = 0.0f;
...
void LarvaPlasmaExplosion(void) {
  ...
  // explosion
  ese.colMuliplier = C_mlBLUE|CT_OPAQUE;
  //ese.betType = BET_EXPLOSION02;
  ese.vStretch = FLOAT3D(1,1,1);
  //SpawnEffect(GetPlacement(), ese);
...
void ProjectileTouch(CEntityPointer penHit)
{
  ...
  if ((m_prtType==PRT_FLAME||m_prtType==PRT_SHOOTER_FLAME) && m_fWaitAfterDeath>0.0f) {
    ...
    {
			/*if (GetSP()->sp_bMental) {
				InflictRangeDamage(m_penLauncher, DMT_BURNING, m_fDamageAmount*fDamageMul, GetPlacement().pl_PositionVector, 3.0f, 8.0f);
			} else {
				InflictDirectDamage(penHit, m_penLauncher, DMT_BURNING, m_fDamageAmount*fDamageMul, GetPlacement().pl_PositionVector, vDirection);
			}*/
      InflictDirectDamage(penHit, m_penLauncher, DMT_BURNING, m_fDamageAmount*fDamageMul, GetPlacement().pl_PositionVector, vDirection);
    }
  ...
  // don't damage the same entity twice (wind blast)
    ...
    if (penHit==m_penLastDamaged) {
      ...
      m_penLastDamaged=penHit;
		...
		/*if (GetSP()->sp_bMental) {
			InflictRangeDamage(m_penLauncher, DMT_EXPLOSION, m_fDamageAmount*fDamageMul, GetPlacement().pl_PositionVector, 3.0f, 8.0f);
		} else {
			InflictDirectDamage(penHit, m_penLauncher, DMT_EXPLOSION, m_fDamageAmount*fDamageMul, GetPlacement().pl_PositionVector, vDirection);
		}*/
    InflictDirectDamage(penHit, m_penLauncher, DMT_EXPLOSION, m_fDamageAmount*fDamageMul, m_fDamageAmount, vDirection);
    // da bomb
  } else if (m_prtType==PRT_BOMB) {
		/*if (GetSP()->sp_bMental) {
			InflictRangeDamage(m_penLauncher, DMT_ACID, m_fDamageAmount*fDamageMul, GetPlacement().pl_PositionVector, 3.0f, 8.0f);
		} else {
			InflictDirectDamage(penHit, m_penLauncher, DMT_ACID, m_fDamageAmount*fDamageMul, GetPlacement().pl_PositionVector, vDirection);
		}*/
    InflictDirectDamage(penHit, m_penLauncher, DMT_ACID, m_fDamageAmount, GetPlacement().pl_PositionVector, vDirection);  
  // other projectiles
  } else {
		/*if (GetSP()->sp_bMental) {
			InflictRangeDamage(m_penLauncher, DMT_EXPLOSION, m_fDamageAmount*fDamageMul, GetPlacement().pl_PositionVector, 3.0f, 8.0f);
...
void ProjectileHit(void)
{
  ...
  m_bRenderParticles = m_bRenderMentalParticles = FALSE;

  // explode ...
  if (m_bExplode) {
    const FLOAT fDamageMul = GetSeriousDamageMultiplier(m_penLauncher);
    if (m_prtType==PRT_BOMB) {
      InflictRangeDamage(m_penLauncher, DMT_ACID, m_fRangeDamageAmount*fDamageMul,
          GetPlacement().pl_PositionVector, m_fDamageHotSpotRange, m_fDamageFallOffRange);
			//InflictBoxDamage(m_penLauncher, DMT_ACID, m_fRangeDamageAmount*fDamageMul, 
				//FLOATaabbox3D(GetPlacement().pl_PositionVector, m_fDamageFallOffRange));
			//InflictBoxDamage(CEntity *penInflictor, enum DamageType dmtType, FLOAT fDamageAmmount, const FLOATaabbox3D &box);
    } else {
      InflictRangeDamage(m_penLauncher, DMT_EXPLOSION, m_fRangeDamageAmount*fDamageMul,
          GetPlacement().pl_PositionVector, m_fDamageHotSpotRange, m_fDamageFallOffRange);
			//InflictBoxDamage(m_penLauncher, DMT_EXPLOSION, m_fRangeDamageAmount*fDamageMul, 
				//FLOATaabbox3D(GetPlacement().pl_PositionVector, m_fDamageFallOffRange));
    }
  }
  // sound event
...
void BounceSound(void) {
  switch (m_prtType) {
    ...
    case PRT_BOT_BOMB:
      if (en_vCurrentTranslationAbsolute.Length() > 3.0f) {
        m_soEffect.Set3DParameters(20.0f, 2.0f, 2.0f, 1.0f);
        PlaySound(m_soEffect, SOUND_GRENADE_BOUNCE, SOF_3D);
      }
      break;
  }
...
procedures:
  ...
  ProjectileGuidedFly(EVoid) {
    ...
    while( _pTimer->CurrentTick()<(m_fStartTime+m_fFlyTime))
    {
      ...
      /*if (m_prtType==PRT_BOT_HOMING_ROCKET) {
        CPrintF("Distance to Target: %.1f\n", DistanceTo(this, m_penTarget));
      }*/
      if (m_prtType==PRT_BOT_HOMING_ROCKET && DistanceTo(this, m_penTarget)<10.0f)
      { 
        // explode now
...
/*      if (m_prtType==PRT_BEAST_BIG_PROJECTILE &&
  ...
  Main(ELaunchProjectile eLaunch) {
    ...
    m_penLastDamaged = NULL;
		...
		m_fProjectileSpeed = GetSP()->sp_fProjectileSpeed;

		if (GetSP()->sp_bMental && IsDerivedFromClass(m_penLauncher, "Enemy Base")) {
			m_bRenderParticles = FALSE;
			m_bRenderMentalParticles = TRUE;
			m_colStar = RGBToColor( IRnd()%255, IRnd()%255, IRnd()%255 );
		} else {
			m_bRenderParticles = TRUE;
			m_bRenderMentalParticles = FALSE;
		}
    ...
    switch (m_prtType) {
      ...
      case PRT_GRENADE_BOMB: //Particles_GrenadeTrail_Prepare(this); break;
      case PRT_BOMB:
      case PRT_BOT_BOMB:
      ...
      case PRT_BEAST_BIG_PROJECTILE:
      case PRT_DEVIL_GUIDED_PROJECTILE:
      case PRT_DEMON_FIREBALL: Particles_FirecrackerTrail_Prepare(this); break;
      case PRT_SHOOTER_FIREBALL: Particles_Fireball01Trail_Prepare(this); break;
      case PRT_KNIFE_PROJECTILE: Particles_KnifeTrail01_Prepare(this); break;
      case PRT_ROCKET_HOMING: Particles_RocketTrail_Prepare(this); break;
			case PRT_FLAMER_PROJECTILE: Particles_BeastBigProjectileTrail_Prepare(this); break;
    }
    ...
    switch (m_prtType)
    {
      ...
      case PRT_GRENADE: PlayerGrenade(); break;
			case PRT_GRENADE_BOMB: PlayerGrenadeBomb(); break;
      case PRT_BOMB: PlayerBomb(); break;
      ...
      case PRT_KNIFE_PROJECTILE: PlayerKnifeProjectile(); break;
      case PRT_ROCKET_HOMING: PlayerHomingRocket(); break;
      case PRT_LASER_BOMB: PlayerLaserBomb(); break;
			case PRT_FLAMER_PROJECTILE: PlayerFlamerProjectile(); break;
      case PRT_BOT_BOMB: BotBomb(); break;
      case PRT_BOT_ROCKET: BotRocket(); break;
      case PRT_BOT_HOMING_ROCKET: BotHomingRocket(); break;
    ...
    switch (m_prtType) {
      ...
      case PRT_GRENADE: PlayerGrenadeExplosion(); break;
			case PRT_GRENADE_BOMB: PlayerGrenadeBombExplosion(); break;
      case PRT_BOMB: 
      case PRT_BOT_BOMB:
        PlayerBombExplosion(); 
        break;
      ...
      case PRT_METEOR: MeteorExplosion(); break;
			case PRT_ROCKET_HOMING: PlayerHomingRocketExplosion(); break;
			case PRT_LASER_BOMB: PlayerLaserBombExplosion(); break;
			case PRT_FLAMER_PROJECTILE: PlayerFlamerProjectileExplosion(); break;
      case PRT_KNIFE_PROJECTILE: PlayerKnifeProjectileImpact(); break;
    }

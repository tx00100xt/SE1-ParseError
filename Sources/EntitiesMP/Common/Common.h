...
// get enemy multiplier
DECL_DLL INDEX GetGameEnemyMultiplier(void);

// get speed adjuster
DECL_DLL FLOAT GetGameSpeedAdjuster(void);

//DECL_DLL FLOAT GetLagFactor(void);

// helper functions
DECL_DLL void ParseCPP(void);
DECL_DLL CTString GetLine(CTStream &strm);
//DECL_DLL CTString g_strLevelName;
//DECL_DLL void SetLevelString(void);

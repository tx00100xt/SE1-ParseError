...
void DECL_DLL Particles_TPTrail(CEntity *pen);
void DECL_DLL Particles_TPTrail_Prepare(CEntity *pen);
void DECL_DLL Particles_SWTrail(CEntity *pen);
void DECL_DLL Particles_SWTrail_Prepare(CEntity *pen);
void DECL_DLL Particles_Rail_Trail(CEntity *pen);
void DECL_DLL Particles_Rail_Trail_Prepare(CEntity *pen);
void DECL_DLL Particles_Flak_Trail(CEntity *pen);
void DECL_DLL Particles_Flak_Trail_Prepare(CEntity *pen);
//void DECL_DLL Particles_Tracer_Trail(CEntity *pen, FLOAT tmStart);
void DECL_DLL Particles_Tracer_Trail(CEntity *pen);
void DECL_DLL Particles_Tracer_Trail_Prepare(CEntity *pen);
...
void DECL_DLL Particles_ExplosionDebris4(CEntity *pen, FLOAT tmStart, FLOAT3D vStretch, COLOR colMultiply=C_WHITE|CT_OPAQUE);
...
void DECL_DLL Particles_Raycast(const FLOAT3D &vSrc, const FLOAT3D &vDst, INDEX ctRays, FLOAT fSize, 
                                COLOR colLine=C_WHITE|CT_OPAQUE);
...
void DECL_DLL Particles_EmptyShells( CEntity *pen, ShellLaunchData *asldData, INDEX iTexture);
void DECL_DLL Particles_ColtShells( CEntity *pen, ShellLaunchData *asldData);
//void DECL_DLL Particles_Combo( CEntity *pen, INDEX iX );
...
void DECL_DLL Particles_Implosion(CEntity *pen, FLOAT tmStart, FLOAT3D vStretch, COLOR colMultiply=C_WHITE|CT_OPAQUE);//(CEntity *pen, FLOAT tmStart, FLOAT tmStop);
//void DECL_DLL Particles_Implosion( CEntity *pen, FLOAT fSize, FLOAT fHeight, INDEX ctParticles, FLOAT fMipFactorDisappear);
...
void DECL_DLL Particles_KnifeTrail01_Prepare(CEntity *pen);
void DECL_DLL Particles_KnifeTrail01(CEntity *pen);
...
void DECL_DLL Particles_ModelGlow3( CEntity *pen, enum ParticleTexture ptTexture, FLOAT fSize, FLOAT iVtxStep, COLOR iCol);
void DECL_DLL Particles_RunAfterBurner(CEntity *pen, FLOAT tmEnd, FLOAT fStretch, INDEX iGradientType);
void DECL_DLL Particles_RunAfterBurner_Prepare(CEntity *pen);
void DECL_DLL Particles_Fireworks00(class CEmiter2 &em);
void DECL_DLL Particles_Fireworks01(class CEmiter2 &em);
void DECL_DLL Particles_Fireworks02(class CEmiter2 &em);
void DECL_DLL Particles_Fireworks03(class CEmiter2 &em);
void DECL_DLL Particles_Fireworks04(class CEmiter2 &em);
void DECL_DLL Particles_Fireworks05(class CEmiter2 &em);
void DECL_DLL Particles_Fireworks06(class CEmiter2 &em);
void DECL_DLL Particles_Fireworks07(class CEmiter2 &em);
void DECL_DLL Particles_Fireworks08(class CEmiter2 &em);
void DECL_DLL Particles_Fireworks09(class CEmiter2 &em);
...
void DECL_DLL Particles_Firework00(CEntity *pen, FLOAT tmStart, FLOAT fSize, COLOR colMultiply);
void DECL_DLL Particles_Firework01(CEntity *pen, FLOAT tmStart, FLOAT fSize, COLOR colMultiply);
void DECL_DLL Particles_Firework02(CEntity *pen, FLOAT tmStart, FLOAT fSize, COLOR colMultiply);
void DECL_DLL Particles_Firework03(CEntity *pen, FLOAT tmStart, FLOAT fSize, COLOR colMultiply);
void DECL_DLL Particles_Firework04(CEntity *pen, FLOAT tmStart, FLOAT fSize, COLOR colMultiply);
void DECL_DLL Particles_Firework05(CEntity *pen, FLOAT tmStart, FLOAT fSize, COLOR colMultiply);
void DECL_DLL Particles_Firework06(CEntity *pen, FLOAT tmStart, FLOAT fSize, COLOR colMultiply);
void DECL_DLL Particles_Firework07(CEntity *pen, FLOAT tmStart, FLOAT fSize, COLOR colMultiply);
void DECL_DLL Particles_Firework08(CEntity *pen, FLOAT tmStart, FLOAT fSize, COLOR colMultiply);
void DECL_DLL Particles_Firework09(CEntity *pen, FLOAT tmStart, FLOAT fSize, COLOR colMultiply);

void DECL_DLL Particles_PlasmaBall(CEntity *pen, FLOAT fSize, FLOAT tmStarted);
void DECL_DLL Particles_PlasmaTrail_Prepare(CEntity *pen);
void DECL_DLL Particles_PlasmaTrail(CEntity *pen, FLOAT fStretch);
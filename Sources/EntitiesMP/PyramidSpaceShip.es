  ...
  Main() {
    ...
    wait() {
      ...
      on( ETrigger):
      {
        ...
        {
          // ignore all triggs
          //CPrintF("Space Ship PSSS_IDLE, ETrigger Skipped\n");
        }
        else if( m_epssState==PSSS_KILLING_BEAM_FIREING)
        {
          //CPrintF("Space Ship FireLightBeam()\n");
          call FireLightBeam();
        }
        else if(m_epssState==PSSS_KILLING_BEAM_FIREING)
        {
      ...
      {
        //CPrintF("Space EForcePathMarker\n");
        if(m_epssState != PSSS_IDLE)
        {
          //CPrintF("Space EForcePathMarker, m_epssState != PSSS_IDLE\n");

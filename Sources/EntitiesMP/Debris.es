...
properties:
  ...
  20 FLOAT m_fLife = 0.0f,
  21 BOOL  m_bExtendLife = FALSE,
	22 BOOL  m_bBones = FALSE,
 ...
 ************************************************************/
  ...
  void RenderParticles(void)
  {
    ...
    case DPT_AFTERBURNER:{
      Particles_AfterBurner( this, m_tmStarted, 0.8f);
                         } break;
...
procedures:
  ...
  Main(ESpawnDebris eSpawn)
  {
    ...
    // wait some time
		FLOAT fWaitBeforeFade=0.5f+m_fLife;
		if (GetSP()->sp_bSinglePlayer) {
			fWaitBeforeFade=5.0f*GetSP()->sp_fGibLife+m_fLife;
		}

    //FLOAT fWaitBeforeFade = 10.0f;

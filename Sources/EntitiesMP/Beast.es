 ...
 ************************************************************/
  Main(EVoid) {
    ...
    StandingAnim();
    // setup moving speed
    m_fWalkSpeed = FRnd()*2 + 5.0f*fWhatever;
    m_aWalkRotateSpeed = AngleDeg(FRnd()*20.0f + 50.0f)*fWhatever;
    m_fCloseRunSpeed = FRnd() + 10.0f*fWhatever;
    m_aCloseRotateSpeed = AngleDeg(FRnd()*100 + 900.0f)*fWhatever;
    ...
    if (m_bcType == BT_NORMAL)
    {
      m_fAttackRunSpeed = 6.0f*fWhatever;//6
      m_aAttackRotateSpeed = AngleDeg(3600.0f)*fWhatever;
      SetHealth(1000.0f*fWhatever);
      ...
      m_iScore = 5000;//500
      // set stretch factor
      GetModelObject()->StretchModel(FLOAT3D(BEAST_STRETCH*fWhatever, BEAST_STRETCH*fWhatever, BEAST_STRETCH*fWhatever));
      ModelChangeNotify();
      m_sptType = SPT_SLIME;
    ...
    {
      m_fAttackRunSpeed = 25.0f*fWhatever;//8
      m_aAttackRotateSpeed = AngleDeg(600.0f)*fWhatever;
      SetHealth(2500.0f*fWhatever);//500
      ...
      m_fCloseDistance = 20;
      // set stretch factor
      GetModelObject()->StretchModel(FLOAT3D(BIG_BEAST_STRETCH*fWhatever, BIG_BEAST_STRETCH*fWhatever, BIG_BEAST_STRETCH*fWhatever));
      ModelChangeNotify();
      m_sptType = SPT_BLOOD;
    ...
    {
      m_fAttackRunSpeed = 35.0f*fWhatever;//8
      m_aAttackRotateSpeed = AngleDeg(600.0f)*fWhatever;
      SetHealth(8000.0f*fWhatever);//500
      ...
      // set stretch factor
      GetModelObject()->StretchModel(FLOAT3D(HUGE_BEAST_STRETCH*fWhatever, HUGE_BEAST_STRETCH*fWhatever, HUGE_BEAST_STRETCH*fWhatever));
      ModelChangeNotify();
      m_sptType = SPT_BLOOD;
      m_fAttackFireTime = 5.0f;
			m_fLagger = 8.0f; 

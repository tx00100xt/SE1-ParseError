 ...
 ************************************************************/
  Fire(EVoid) : CEnemyBase::Fire
  {
    ...
    plFX.pl_PositionVector=plFX.pl_PositionVector+vFireballLaunchPos*m*fWhatever;
    ESpawnEffect ese;
    ese.colMuliplier = C_WHITE|CT_OPAQUE;
    ese.betType = BET_COLLECT_ENERGY;
    ese.vStretch = FLOAT3D(1.0f*fWhatever, 1.0f*fWhatever, 1.0f*fWhatever);
    ...
    pmoFire->StretchModel(FLOAT3D(DEMON_STRETCH*fWhatever, DEMON_STRETCH*fWhatever, DEMON_STRETCH*fWhatever));
    autowait(2.94f-2.4f);
 ...
 ************************************************************/
  Main(EVoid) {
    ...
    StandingAnim();
    // setup moving speed
    /*m_fWalkSpeed = FRnd()/1.0f + 12.0f*fWhatever;
    m_aWalkRotateSpeed = AngleDeg(FRnd()*20.0f + 50.0f)*fWhatever;
    m_fCloseRunSpeed = FRnd()/1.0f + 13.0f*fWhatever;
    m_aCloseRotateSpeed = AngleDeg(FRnd()*100 + 900.0f)*fWhatever;
    m_fAttackRunSpeed = FRnd()/1.0f + 9.0f*fWhatever;
    m_aAttackRotateSpeed = AngleDeg(FRnd()*100.0f + 900.0f)*fWhatever;*/
    ...
    m_fLockOnEnemyTime = 3.0f;
	  m_fLagger = 5.0; 
    // set stretch factor
    GetModelObject()->StretchModel(FLOAT3D(4.2f*fWhatever, 4.2f*fWhatever, 4.2f*fWhatever));
    ModelChangeNotify();

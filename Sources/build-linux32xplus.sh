...
cp -vfr Debug/*.so ../../x32/SamTSE/Mods/PESE2HD/Bin
cp -vfr Debug/libEntitiesMP.so ../../x32/SamTFE/Mods/PEFE2HD/Bin/libEntities.so
cp -vfr Debug/libGameMP.so ../../x32/SamTFE/Mods/PEFE2HD/Bin/libGame.so

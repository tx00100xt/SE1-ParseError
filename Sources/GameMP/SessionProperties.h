...
public:
  ...
  BOOL  sp_bUseExtraEnemies;  // spawn extra multiplayer enemies
	...
	// NEW CODE GAME OPTIONS
	// extra enemy stuff
  BOOL  sp_bExtraEnemiesPerPlayer;
  INDEX sp_iEnemyMultiplier;
  FLOAT sp_fExtraEnemiesPerPlayerRatio;
  INDEX sp_iEnemyMax;
	FLOAT sp_fEnemySpeedAdjuster;
	FLOAT sp_fPlayerDamageAdjuster;
  FLOAT sp_fGibLife;

	// general game options
  BOOL  sp_bDamageSelf;
  BOOL  sp_bGiveAllWeapons;
  FLOAT sp_fSpeedAdjuster;
	BOOL  sp_bControlRunning;
	BOOL  sp_bBackwardsGame;
  INDEX sp_iPostTGPLevel;
	BOOL  sp_bSkipLuxor;
	BOOL  sp_bSkipSewers;
	BOOL  sp_bRandomLevels;
	BOOL  sp_bControlFlying;
	BOOL  sp_bUsePEHealth;

	// weapons options
  BOOL  sp_bMaskChainsaw;
  BOOL  sp_bMaskColt;
  BOOL  sp_bMaskSingleShotgun;
  BOOL  sp_bMaskSniper;
  BOOL  sp_bMaskFlamer;
  BOOL  sp_bMaskTommyGun;
  BOOL  sp_bMaskRocketLauncher;
  BOOL  sp_bMaskGrenadeLauncher;
  BOOL  sp_bMaskMiniGun;
  BOOL  sp_bMaskLaser;
  BOOL  sp_bMaskCannon;
	BOOL  sp_bMaskTeleGun;
	FLOAT	sp_fWeaponsFireRate;
	FLOAT sp_fWeaponsDamage;
	FLOAT sp_fProjectileSpeed;

  // bot options
	BOOL  sp_bUseBots;
  INDEX sp_iBotsPerPlayer;
  FLOAT sp_fBotSkill;

	// spawner battery options
	BOOL sp_bTestSpawnerBatteries;

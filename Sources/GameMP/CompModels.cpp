...
//    _fFOV = 30;
    ...
    pmo->SetData_t(CTFILENAME("Models\\Weapons\\Mini1\\Mini1GunItem.mdl"));
    pmo->mo_toTexture.SetData_t(CTFILENAME("Models\\Weapons\\Mini1\\Barrels.tex"));
    _plModel = CPlacement3D(FLOAT3D(0,-0.75f,-3.75f), ANGLE3D(0,10,0));
    _aRotation = ANGLE3D(100,0,0);

    AddAttachment_t(pmo, MINI1GUNITEM_ATTACHMENT_BODY, 
      CTFILENAME("Models\\Weapons\\Mini1\\Body.mdl"), 0,
      CTFILENAME("Models\\Weapons\\Mini1\\Body.tex"),
      CTFILENAME("Models\\ReflectionTextures\\LightMetal01.tex"),
      CTFILENAME("Models\\SpecularTextures\\Medium.tex"));
    AddAttachment_t(pmo, MINI1GUNITEM_ATTACHMENT_ENGINE, 
      CTFILENAME("Models\\Weapons\\Mini1\\Engine.mdl"), 0,
      CTFILENAME("Models\\Weapons\\Mini1\\Barrels.tex"),
      CTFILENAME("Models\\ReflectionTextures\\LightMetal01.tex"),
      CTFILENAME("Models\\SpecularTextures\\Medium.tex"));
    AddAttachment_t(pmo, MINI1GUNITEM_ATTACHMENT_BARRELS, 
      CTFILENAME("Models\\Weapons\\Mini1\\Barrels.mdl"), 0,
      CTFILENAME("Models\\Weapons\\Mini1\\Barrels.tex"),
      CTFILENAME("Models\\ReflectionTextures\\LightMetal01.tex"),
      CTFILENAME("Models\\SpecularTextures\\Medium.tex"));
...
/*    pmo->SetData_t(CTFILENAME("Models\\Weapons\\Tommygun\\TommygunItem.mdl"));
    ...
    pmo->SetData_t(CTFILENAME("Models\\Weapons\\Mini2\\Mini2GunItem.mdl"));
    pmo->mo_toTexture.SetData_t(CTFILENAME("Models\\Weapons\\Mini2\\Barrels.tex"));
    _plModel = CPlacement3D(FLOAT3D(0,-0.5f,-3.75f), ANGLE3D(0,10,0));
    _aRotation = ANGLE3D(100,0,0);
    AddAttachment_t(pmo, MINI2GUNITEM_ATTACHMENT_BODY, 
      CTFILENAME("Models\\Weapons\\Mini2\\Body.mdl"), 0,
      CTFILENAME("Models\\Weapons\\Mini2\\Body.tex"),
      CTFILENAME("Models\\ReflectionTextures\\LightMetal01.tex"),
      CTFILENAME("Models\\SpecularTextures\\Medium.tex"));
    AddAttachment_t(pmo, MINI2GUNITEM_ATTACHMENT_BARRELS01, 
      CTFILENAME("Models\\Weapons\\Mini2\\Barrels01.mdl"), 0,
      CTFILENAME("Models\\Weapons\\Mini2\\Barrels.tex"),
      CTFILENAME("Models\\ReflectionTextures\\LightMetal01.tex"),
      CTFILENAME("Models\\SpecularTextures\\Medium.tex"));
    AddAttachment_t(pmo, MINI2GUNITEM_ATTACHMENT_BARRELS02, 
      CTFILENAME("Models\\Weapons\\Mini2\\Barrels02.mdl"), 0,
      CTFILENAME("Models\\Weapons\\Mini2\\Barrels.tex"),
      CTFILENAME("Models\\ReflectionTextures\\LightMetal01.tex"),
      CTFILENAME("Models\\SpecularTextures\\Medium.tex"));
    AddAttachment_t(pmo, MINI2GUNITEM_ATTACHMENT_ENGINE, 
      CTFILENAME("Models\\Weapons\\Mini2\\Engine.mdl"), 0,
      CTFILENAME("Models\\Weapons\\Mini2\\Barrels.tex"),
      CTFILENAME("Models\\ReflectionTextures\\LightMetal01.tex"),
      CTFILENAME("Models\\SpecularTextures\\Medium.tex"));
    pmo->StretchModel(FLOAT3D(1.75,1.75,1.75));

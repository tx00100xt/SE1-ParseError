...
cp -vfr Debug/*.so ../../x32/SamTSE/Mods/PESE2/Bin
cp -vfr Debug/libEntitiesMP.so ../../x32/SamTFE/Mods/PEFE2/Bin/libEntities.so
cp -vfr Debug/libGameMP.so ../../x32/SamTFE/Mods/PEFE2/Bin/libGame.so
